        ...
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-12 text-center">
                    <div class="btn-group">
                        <div id="users" class="btn btn-default">Сотрудники</div>
                        <div id="departments" class="active btn btn-default">Отделы</div>
...
<div id="big-container">
    <div class="section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <form role="form" action="{{ route('DepartmentController.update', $department->id) }}" method="post">
                        @csrf
                        @method('PATCH')
                        <div class="form-group">
                            ...
                            <input name="department_name" class="form-control{{ $errors->has('department_name') ? ' is-invalid' : '' }}"
                                autofocus type="text" value="{{ $department->name }}">
    ...
    <div class="section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('DepartmentController.destroy', $department->id)}}" method="post">
                        @csrf
                        @method('DELETE')
                        <button onclick="return confirm('Удалить отдел?')" class="btn btn-danger" type="submit">Удалить</button>
                    </form>
                </div>
            </div>
        </div>
...
<script src="{{ asset('js/department-edit.js') }}" type="text/javascript"></script>
@endsection
